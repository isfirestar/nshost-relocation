...
#if !defined external_visible
    #if _WIN32
        #define external_visible __declspec (dllexport)
    #else
        #define external_visible __attribute__((visibility("default")))
    #endif
#endif

/* macro of export format */
#define interface_format(_Ty) __extern__ external_visible _Ty STDCALL
